...
namespace Zeta.Core.Abstractions
{
    ...
    public interface IDistributedCronRuntime
    {
        ...
        /// </summary>
        Task RegisterTickSource(string id, CronConfig config);

        /// <summary>
        /// Retrieves the current state of a distributed tick source.
        /// </summary>
        Task<CronState> GetState(string id);

        /// <summary>
        /// Suspends a ticking actor (stops the cron).
        /// </summary>
        Task Suspend(string id, string reason);

        /// <summary>
        /// Resumes a suspended actor.
        /// </summary>
        Task ResumeCron(string id);

        /// <summary>
        /// Binds a callback to the tick event. When the distributed runtime fires,
        /// this callback is executed.
        /// </summary>
        Task OnTick(string id, Func<DateTime, Task> callback);
    }
}
