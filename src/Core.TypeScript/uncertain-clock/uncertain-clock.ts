...
export function send(c: Hlc, nowPhysical: number): Hlc {
...
export function receive(c: Hlc, msg: Hlc, nowPhysical: number): Hlc {
...
export function uncertain(aPhysical: number, aEps: number, bPhysical: number, bEps: number): boolean {
  return (
    !definitelyBefore(aPhysical, aEps, bPhysical, bEps) &&
