 ...
 */
export function verifyEulerMaclaurin(delta: number, nTerms: number = 10000): EulerMaclaurinResult {
  // I(ν) = exp(-ν)
 ...
 */
export function computeBerryKeatingEigenvalues(nEigenvalues: number = 50): BerryKeatingResult {
 ...
 */
export function checkTickSamplingSpectrum(delta: number = 0.1): TickSamplingResult {
