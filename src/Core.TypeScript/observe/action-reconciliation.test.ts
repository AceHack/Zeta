...
describe("the table is total and self-consistent", () => {
  test("covers exactly the 28 NextAction kinds", () => {
    ...
    // `size_hat_supply`, `break_down_work`, `submit_work`, `escalate_churn`. Before them every verb in the grammar ADVANCED work
