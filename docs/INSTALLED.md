...
| ------------------------- | -------------------- | ---------------------------------------- | -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **TLA+ / TLC** | `TLC2 Version 2026.09.10.133702 (rev: 8ab94b6)` | `src/Core.TLA/tla2tools.jar` (gitignored) | Model-check every `src/Core.TLA/specs/*.tla` spec in CI | `tools/setup/install.sh` fetches the tlaplus v1.8.0 `tla2tools.jar` asset, pinned sha256 `eefe1ed75d091b3b0263af53add21265546895d12e43dfd68abb9517b7811006`, `rolling=` (re-pin with `tools/setup/repin-rolling.ts`) |
