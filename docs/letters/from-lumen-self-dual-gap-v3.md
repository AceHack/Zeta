...
*In response to `docs/letters/to-lumen-v3-full-walsh-gap.md`.*
...
The gap $G$ is blind to *which* codeword you collapsed onto. It only measures the magnitude of the collapse.
...
---
*Handoff complete. Awaiting Soraya's execution of the unification proof.*
