...
source generation or measurement was performed. The separate
[actual native slice replay](2026-09-07-hidden-switch-compiled-native-slice-replay.md)
has its own narrower numerical conformance scope; neither record upgrades
the other to whole-runtime admission.
