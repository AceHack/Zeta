...
| `ImaginaryStack/ErasureDistance.lean` | Erasure-correction principle (distance ⇒ any `<d` erasures correctable; distance-5 ⇒ any 12-of-16) — machine-checked, sorry-free (2026-06-05) |
