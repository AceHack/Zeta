...
import { isCanonical, ZETAID_BASE32_LEN } from "../../src/Core.TypeScript/zeta-id/encoding";
...
function main(argv: readonly string[]): number {
  ...
  if (!target) {
    process.stderr.write("Usage: bun tools/backlog/complete-workitem.ts <zetaid|path> [--dir workitems] [--dry-run]\n");
    return 2;
  }
